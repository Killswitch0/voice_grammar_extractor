...
from voxlib.diarization import IdentifiedSegment, Segment
...
class FakeDiarizer:
    ...
    def identify_my_segments(self, wav_path, segments, reference_embedding, threshold):
        ...
        for seg in segments:
            ...
            result.append(IdentifiedSegment(start=seg.start, end=seg.end, is_me=sim >= threshold, similarity=sim))
        return result
